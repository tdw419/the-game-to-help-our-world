...
LOCAL_REPO_PATH = "LOCAL_REPO_PATH = "C:/zion/wwwroot/projects/the-game-to-help-our-world"
LOCAL_VAULT_PATH = os.path.join(LOCAL_REPO_PATH, "image_element/vault/sync/image_element_vault.png")
